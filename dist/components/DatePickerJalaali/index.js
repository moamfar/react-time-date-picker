...
const DatePickerJalaali = (_a) => {
    var _b, _c, _d, _e;
    var props = __rest(_a, []);
    const { selectedDate, setSelectedDate, maxYear = (0, moment_jalaali_1.default)().jYear(), minYear = (0, moment_jalaali_1.default)().jYear() - 100, submitCallback, submitTitle = "ثبت", buttonClassName = "w-full bg-black rounded-md flex items-center justify-center h-10", submitTitleClassName = "text-white", containerClassName = "flex flex-row items-center justify-between  w-full px-4 h-[18rem] overflow-hidden relative", } = props;
    ...
    const formatSelectedDate = (selectedDate) => {
        return {
            ...
            month: months_util_1.JALAALI_MONTHS.find((i) => (i === null || i === void 0 ? void 0 : i.id) == Number(selectedDate === null || selectedDate === void 0 ? void 0 : selectedDate.month)) || (months_util_1.JALAALI_MONTHS === null || months_util_1.JALAALI_MONTHS === void 0 ? void 0 : months_util_1.JALAALI_MONTHS[0]),
    ...
    const SELECTED = !!selectedDate
        ...
        : {
            year: YEARS.find((i) => (i === null || i === void 0 ? void 0 : i.id) == Number(NOW.jYear())) || (YEARS === null || YEARS === void 0 ? void 0 : YEARS[0]),
            month: months_util_1.JALAALI_MONTHS.find((i) => (i === null || i === void 0 ? void 0 : i.id) == Number(NOW.jMonth() + 1)) || (months_util_1.JALAALI_MONTHS === null || months_util_1.JALAALI_MONTHS === void 0 ? void 0 : months_util_1.JALAALI_MONTHS[0]),
            day: { id: (0, moment_jalaali_1.default)(NOW).jDate(), title: (0, moment_jalaali_1.default)(NOW).jDate() },
        };
    const valueRef = (0, react_1.useRef)(SELECTED);
    const [days_array, set_days_array] = (0, react_1.useState)((0, generateDays_helper_1.generateDaysJalaali)(Number(((_b = SELECTED === null || SELECTED === void 0 ? void 0 : SELECTED.month) === null || _b === void 0 ? void 0 : _b.id) || ((_c = valueRef.current.month) === null || _c === void 0 ? void 0 : _c.id)), Number(((_d = SELECTED === null || SELECTED === void 0 ? void 0 : SELECTED.year) === null || _d === void 0 ? void 0 : _d.id) || ((_e = valueRef.current.year) === null || _e === void 0 ? void 0 : _e.id))));
    const _onValueChange = (refValue, value) => {
        ...
        if (refValue == "month" || refValue == "year") {
            const TEMP = (0, generateDays_helper_1.generateDaysJalaali)(Number((_a = valueRef.current.month) === null || _a === void 0 ? void 0 : _a.id), Number((_b = valueRef.current.year) === null || _b === void 0 ? void 0 : _b.id));
            set_days_array((days) => {
    ...
    return (react_1.default.createElement(react_1.Fragment, null,
        react_1.default.createElement("div", { className: containerClassName },
            ...
            react_1.default.createElement(WheelPicker_1.default, { perspective: "center", defaultValue: valueRef.current.month, slides: months_util_1.JALAALI_MONTHS, onSelect: (value) => _onValueChange("month", value) }),
            react_1.default.createElement(WheelPicker_1.default, { perspective: "right", defaultValue: valueRef.current.year, slides: YEARS, onSelect: (value) => _onValueChange("year", value) })),
...
exports.default = DatePickerJalaali;
